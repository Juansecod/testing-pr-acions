...
export class SalasController {
  ...
  @ApiResponse({ status: 200, description: 'Return all data about individual rooms available' })
  ...
  @ApiResponse({ status: 200, description: 'Return all data about multiple rooms available' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 404, description: 'Solicitud Not Found' })
  ...
  @ApiResponse({ status: 200, description: 'Return all data about individual schedule available' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 404, description: 'Solicitud Not Found' })
  ...
  @ApiResponse({ status: 200, description: 'Return all data about multiple schedule available' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 404, description: 'Solicitud Not Found' })
