...
describe('SalasController', () => {
  ...
  const mockSalasService = {
    verificarDisponibilidadIndividual: jest.fn((id) => [{ SAL_ID: id, disponible: true }]),
    verificarDisponibilidadCombinada: jest.fn((id) => [{ SAL_ID: id, disponible: false }]),
    obtenerIntervalosIndividuales: jest.fn((id) => [{ horaInicio: '08:00', horaFin: '10:00' }]),
    obtenerIntervalosCombinados: jest.fn((id) => [{ horaInicio: '10:00', horaFin: '12:00' }]),
  };
