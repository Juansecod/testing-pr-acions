...
describe('SolicitudService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: getRepositoryToken(Secretaria), useValue: mockSecretariaRepo },
  ...
  describe('aprobarSolicitud', () => {
    it('debería aprobar una solicitud', async () => {
      mockSolicitudRepo.findOne.mockResolvedValue({ id_solicitudes: 1, Estado: 2 });
  ...
  describe('rechazarSolicitud', () => {
    it('debería rechazar una solicitud', async () => {
      mockSolicitudRepo.findOne.mockResolvedValue({ id_solicitudes: 2, Estado: 2 });
  ...
  describe('createSolicitud', () => {
    ...
    it('debería lanzar BadRequestException si la secretaria o el usuario no existen', async () => {
      ...
      await expect(service.createSolicitud({ 
        id_user: 99, 
        ministry: 'Inexistente', purpose: 'Prueba',
        fecha_reserva: "20-02-2025",
        startTime: "10:00:00",
        endTime: "12:00:00",
        assistants: 10
       } as SolicitudDto)).rejects.toThrow(
